...
const Aurora = ({
  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColorStops: { value: formatStops(colorStops) },
  ...
  const classes = ["aurora-container", className].filter(Boolean).join(" ");
